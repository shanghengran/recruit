            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="box-panel">
                        ...
                        <form class="row" action="${pageContext.request.contextPath }/job/createJobDo" method="post">
                            <input type="hidden" name="fid" value="${CUR_FIRM.fid}"/>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>职位名称：</label>
                                    <input type="text" placeholder="" class="form-control" name="jobName">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>职位薪水：</label>
                                    <input type="text" placeholder="" class="form-control" name="pay">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label>职位诱惑：</label>
                                    <input type="text" id="tags" value="" class="form-control" data-role="tagsinput" name="attract">
                                </div>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <button class="btn btn-default pull-right">发布职位 <i class="fa fa-angle-right"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<%--<body>--%>
    ...
    <%--<header>--%>
        ...
        <%--</div>--%>
    <%--</header>--%>
    <%--<form action="${pageContext.request.contextPath }/job/createJobDo" method="post">--%>
        <%--<fieldset>--%>
            <%--<legend>发布职位</legend><br><br>--%>
            <%--<div class="edit">--%>
                <%--<span><span style="color:red">*</span>职位名称：</span><input type="text" name="jobName"/><br/><br/>--%>
                <%--<span><span style="color:red">*</span>职位薪水：</span><input type="text" name="pay"/><br/><br/>--%>
                ...
                <%--<select name="reqEducation">--%>
                    ...
                    <%--<option value="博士">博士</option>--%>
                <%--</select><br/><br/>--%>
                <%--<span><span style="color:red">*</span>职位诱惑：</span><br/><textarea name="attract" cols="30" rows="5" ></textarea><br/><br/>--%>
                <%--<span><span style="color:red">*</span>职位描述：</span><br/><textarea name="description" cols="30" rows="10" ></textarea><br/><br/>--%>
                <%--<input type="hidden" name="fid" value="${CUR_FIRM.fid}"/>--%>
