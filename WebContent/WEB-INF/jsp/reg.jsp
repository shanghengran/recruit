...
<head>
    ...
    <title>梦之航 - 注册/登录</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/css/auth.css">
</head>

<body>
<div style="float: right;margin-right: 1200px"><a href="${pageContext.request.contextPath }/user/userIndex"><img src="${pageContext.request.contextPath }/img/web_logo_4.png" alt=""></a></div>
<div class="lowin">
...
<script type="text/javascript">
    ...
    function regCheck() {
        if($("#reg_username").val().length==0||$("#reg_password").val().length==0 ||$("#reg_confirm").val().length==0
            || $('input:radio[name="user_type"]:checked').val()==null){
            alert("账号或密码或类型不能为空！");
        }else{
            alert("注册成功！");
        }
