                            ...
                            <div class="resume-list">
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${JOBS.lists }" var="job" varStatus="s">
                                        <tr>
                                            <td><h5>${s.count }</h5></td>
                                            <td><h5>${job.jobName }</h5></td>
                                            <td><a class="btn btn-primary" href="${pageContext.request.contextPath }/job/updateJob?jid=${job.jid}"> 修改 </a></td>
                                            <td><a class="btn btn-danger" href="${pageContext.request.contextPath }/job/deleteJob?jid=${job.jid}"> 删除 </a></td>
                                        </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
                                            ...
                                            <ul class="pagination">
                                                <li>
                                                    <c:if test="${JOBS.pageNow > 1 }">
                                                        <a href="${pageContext.request.contextPath }/firm/jobsList?pageNow=1">首页</a>
                                                        <a href="${pageContext.request.contextPath }/firm/jobsList?pageNow=${JOBS.pageNow - 1 }"><span aria-hidden="true">«</span></a>
                                                    </c:if>
                                                </li>
                                                <c:forEach begin="1" end="${JOBS.pageCount }" step="1" var="i">
                                                    ...
                                                    <c:if test="${JOBS.pageNow != i }">
                                                        <li><a href="${pageContext.request.contextPath }/firm/jobsList?pageNow=${i }">${i }</a></li>
                                                    </c:if>
                                                </c:forEach>
                                                <li>
                                                    <c:if test="${JOBS.pageNow < JOBS.pageCount }">
                                                        <a href="${pageContext.request.contextPath }/firm/jobsList?pageNow=${JOBS.pageNow + 1 }"><span aria-hidden="true">»</span></a>
                                                        <a href="${pageContext.request.contextPath }/firm/jobsList?pageNow=${JOBS.pageCount }">尾页</a>
                                                    </c:if>
                                                </li>
                                            </ul>
                                        </div>
