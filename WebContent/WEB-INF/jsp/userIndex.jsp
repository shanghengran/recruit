...
<div class="page">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="cat-title">招聘职位浏览</div>
					</div>
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="panel-body">
							<div class="tab-content">
								<div class="animated fadeInUp" id="tab3" >
									<div class="col-md-12 col-sm-12 col-xs-12 nopadding">
										<c:forEach items="${ALLJOBS.lists }" var="job">
											<div class="job-box">
												...
												<div class="col-md-2 col-sm-2 col-xs-12">
													<button class="btn btn-primary btn-custom"><i class="fa fa-location-arrow"></i>&nbsp;<a href="${pageContext.request.contextPath }/user/viewFirm?fid=${job.firm.fid }&jid=${job.jid }">${job.firm.firmName }</a></button>
												</div>
											</div>
										</c:forEach>
										<div class="col-md-12 col-sm-12 col-xs-12 nopadding" style="margin-top: 10px">
											<div class="pagination-box clearfix">
												<ul class="pagination">
													<li>
														<c:if test="${ALLJOBS.pageNow > 1 }">
															<a href="${pageContext.request.contextPath }/user/userIndex?pageNow=1">首页</a>&nbsp;
															<a href="${pageContext.request.contextPath }/user/userIndex?pageNow=${ALLJOBS.pageNow - 1 }">上一页</a>&nbsp;
														</c:if>
													</li>
													<c:forEach begin="1" end="${ALLJOBS.pageCount }" step="1" var="i">
														<c:if test="${ALLJOBS.pageNow == i }">
															<li class="active"><a href="#">${i }</a></li>
														</c:if>
														<c:if test="${ALLJOBS.pageNow != i }">
															<li><a href="${pageContext.request.contextPath }/user/userIndex?pageNow=${i }">${i }</a>&nbsp;</li>
														</c:if>
													</c:forEach>
													<li>
														<c:if test="${ALLJOBS.pageNow < ALLJOBS.pageCount }">
															<a href="${pageContext.request.contextPath }/user/userIndex?pageNow=${ALLJOBS.pageNow + 1 }">下一页</a>&nbsp;
															<a href="${pageContext.request.contextPath }/user/userIndex?pageNow=${ALLJOBS.pageCount }">尾页</a>
														</c:if>
													</li>
												</ul>
											</div>
	...
	<!-- TEXT ROTATOR -->
	<script type="text/javascript" src="${pageContext.request.contextPath }/basic/js/typed.js"></script>
	...
	<script type="text/javascript">
        $(function(){
            $(".search-main-title").typed({
                strings: ["Welcome to Dream sailing", "Geting A job, Leading to success", "One million success stories. Start yours today !"],
                typeSpeed: 90
            });
        });
	</script>
...
<%--<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">--%>
<%--<title>梦之航招聘主页</title>--%>
<%--<link rel="stylesheet" href="${pageContext.request.contextPath }/${pageContext.request.contextPath }/basic/css/userIndex_style.css"/>--%>
<%--<link rel="stylesheet" href="${pageContext.request.contextPath }/${pageContext.request.contextPath }/basic/css/header_style.css"/>--%>
<%--<link rel="stylesheet" href="${pageContext.request.contextPath }/${pageContext.request.contextPath }/basic/css/bg_style.css"/>--%>
<%--<link rel="stylesheet" href="${pageContext.request.contextPath }/${pageContext.request.contextPath }/basic/css/foot.css"/>--%>
<%--</head>--%>
<%--<body>--%>
<%--<c:if test="${CUR_USER == null }">--%>
<%--<div class="header">--%>
<%--<a href="${pageContext.request.contextPath }/user/login"><img height="20px" src="${pageContext.request.contextPath }/photo/loginlogo.png" style="margin-top:5px"> 登录 </a>/ --%>
...
<%--<form action="${pageContext.request.contextPath }/user/searchJobs" method="post">--%>
<%--<div class="d2">--%>
<%--<input type="text" name="jobName"  size="60" placeholder=" 请输入你要搜索的职位 :" style="height:31px; color:#999; font-size:14px;"/>--%>
<%--</div>--%>
...
<%--</tr>--%>
<%--<tr>--%>
<%--<td width="30%"><a href="${pageContext.request.contextPath }/resume/viewJob?jid=${job.jid}">${job.jobName }</a></td>--%>
<%--<td width="15%">${job.pay }</td>--%>
<%--<td width="15%">${job.reqExperience }</td>--%>
<%--<td width="15%">${job.reqEducation }</td>--%>
<%--<td width="25%"><a href="${pageContext.request.contextPath }/user/viewFirm?fid=${job.firm.fid }&jid=${job.jid }">${job.firm.firmName }</a></td>--%>
<%--</tr>--%>
<%--</table>--%>
<%--<br/>--%>
<%--</c:forEach>--%>
...
<%--</c:if>--%>
<%--<c:if test="${ALLJOBS.pageNow != i }">--%>
<%--<a href="${pageContext.request.contextPath }/user/userIndex?pageNow=${i }">${i }</a>--%>
<%--</c:if>--%>
<%--</c:forEach>--%>
<%--<c:if test="${ALLJOBS.pageNow < ALLJOBS.pageCount }">--%>
<%--<a href="${pageContext.request.contextPath }/user/userIndex?pageNow=${ALLJOBS.pageNow + 1 }">下一页</a>--%>
