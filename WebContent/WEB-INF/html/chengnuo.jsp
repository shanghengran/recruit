...
/*reset*/
	...
	.intro_service{background:url(http://img4.ddimg.cn/00012/dang/about_service.gif) no-repeat scroll 10px 25px transparent;padding-top:1px;}
<!--
body,td,th {
	font-family: 宋体;
	font-size: 12px;
...
<LI class=black><A href="javascript:void(0);">服务承诺</A> </LI></UL></DIV>
...
<LI class="intro_title intro_service">服务承诺 </LI></UL></DIV>
<DIV class=content>
<UL class="mission_list first last">
<LI> 精诚所至， 金石为开。</LI>
<LI></LI>
<LI></LI>
</UL>
</DIV>
<IMG src="${pageContext.request.contextPath }/img/about_line.gif">
</DIV>
</DIV>
<BR style="CLEAR: both">
<!--#include virtual="/_fetch_/incFooter.html"-->
</body>
</html>