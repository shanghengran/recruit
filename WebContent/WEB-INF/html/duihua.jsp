...
/*reset*/
	...
	a{ color:#878787;}
	.black,.black a,.black a:hover{ font-weight:bold;}
	...
	.intro_contact{background:url(http://img4.ddimg.cn/00030/job/about_contact_1.gif) no-repeat scroll 10px 25px transparent;padding-top:1px;}
	
	.linklist {padding:40px 0 50px 65px;}
	.linklist ul {overflow:hidden;width:643px;}
	.linklist li {background:url(http://img4.ddimg.cn/00030/job/bg_contact_li.gif) no-repeat 13px 8px;height:18px;padding:4px 0 2px 26px;vertival-align:top;}
	.linklist li span {color:#878787;display:inline;float:left;margin-right:3px;}
	.linklist li a {color:#1a66b3;display:inline;float:left;font-family:Arial;}
	.linklist li a:hover {color:#1a66b3;}
<!--
body,td,th {
	font-family: 宋体;
	font-size: 12px;
...
<LI class=black><A href="javascript:void(0);">对话梦之航</A></LI>
...
<LI class="intro_title intro_contact">对话梦之航</LI></UL></DIV>
<DIV class=content>
<P><IMG alt=这里为您开启心与心的交流，敞开心扉聆听您的声音！ src="http://img4.ddimg.cn/00030/job/bg_contact_title.gif"></P>
<DIV class=linklist>
<UL>
<LI class=first><SPAN>官方BLOG:</SPAN><A href=""></A>
<DIV class=clear></DIV></LI>
<LI><SPAN>官方微博:</SPAN><A href=""></A>
<DIV class=clear></DIV></LI>
<LI><SPAN>梦之航论坛:</SPAN><A href=""></A>
